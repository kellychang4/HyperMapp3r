...
def parsefn():
    parser = argparse.ArgumentParser(description='Generates volumetric summary of hyperocampus segmentations',
    ...
    required.add_argument('-o', '--out_csv', type=str, metavar='',
                          help='output stats ex: hp_vols_summary.csv', default='hyper_volumes.csv')
...
def main(args):
    ...
    df = df[(df.T != 0).any()]
    print('saving hyperocampus volumetric csv')
